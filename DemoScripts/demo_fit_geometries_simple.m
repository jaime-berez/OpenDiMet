...
myFeature = fitFeature(data1, "Plane", "ConstrainedMinimumTotalDistance", "Name", StepTol = 1e-9, ...
    GradTol = 1e-11, SSETol = 1e-19, Lambda = 1e-4, DampingCoeff = 2, refDir = [0.3560 -0.7511 -0.5560]);  % <----- Input
