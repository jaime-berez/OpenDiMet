...
for i=1:numOfFiles %Loop through all the files
    ...
    switch geometry
        case 1 % 2d Line
            ...
            Line=fitFeature('lin',data,"Line","LeastSquares"); % Associate 2d Line
        ...
        case 2 % 3d Line
            ...
            reference=readmatrix(filePath+string(i)+".fit",'FileType','text');
            t0=tic; %Start a timer to track the association time
            Line=fitFeature('lin',data,"Line","LeastSquares"); % Associate 23d Line
            t1=toc(t0); %End the timer
            poi=Line.point;
            dir=Line.direction;
        case 3 % Plane
            ...
            reference=readmatrix(filePath+string(i)+".fit",'FileType','text');
            t0=tic; %Start a timer to track the association time
            Plane=fitFeature('pla',data,"Plane","LeastSquares"); % Associate Plane
            t1=toc(t0); %End the timer
            poi=Plane.point;
            dir=Plane.direction;
        case 4 % 2d Circle
            ...
            reference=readmatrix(filePath+string(i)+".fit",'FileType','text');
            t0=tic; %Start a timer to track the association time
            Circle=fitFeature('cir',data,"Circle","LeastSquares"); % Associate 2d Circle
            t1=toc(t0); %End the timer
            poi=Circle.point;
        ...
        case 5 % 3d circle
            ...
            reference=readmatrix(filePath+string(i)+".fit",'FileType','text');
            t0=tic; %Start a timer to track the association time
            Circle=fitFeature('cir',data,"Circle","LeastSquares"); % Associate 3d Circle
            t1=toc(t0); %End the timer
            poi=Circle.point;
            dir=Circle.direction;
            dis=Circle.diameter;
        case 6 % Sphere
            ...
            reference=readmatrix(filePath+string(i)+".fit",'FileType','text');
            t0=tic; %Start a timer to track the association time
            Sphere=fitFeature('sph',data,"Sphere","LeastSquares"); % Associate Sphere
            t1=toc(t0); %End the timer
            poi=Sphere.point;
            dis=Sphere.diameter;
        case 7 % Cylinder
            ...
            reference=readmatrix(filePath+string(i)+".fit",'FileType','text');
            t0=tic; %Start a timer to track the association time
            Cylinder=fitFeature('cyl',data,"Cylinder","LeastSquares"); % Associate Cylinder
            t1=toc(t0); %End the timer
            poi=Cylinder.point;
        ...
        case 8 % Cone
            ...
            reference=readmatrix(filePath+string(i)+".fit",'FileType','text');
            t0=tic; %Start a timer to track the association time
            Cone=fitFeature('con',data,"Cone","LeastSquares"); % Associate Cone
            t1=toc(t0); %End the timer
            poi=Cone.point;
            dir=Cone.direction;
            dis=Cone.distance;
